    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
                ...
                <Badge variant="secondary">Maybe Going : {event.maybeCount}</Badge>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <p className="text-sm text-muted-foreground">
                        Share this link with guests so that they can RSVP without creating an account
                    </p>
                                        ...
                                        <TableCell>
                                            <Badge variant="secondary">
                                                {rsvp.status === "not_going"
                                                    ? "Not Going"
                                                    : (rsvp.status as string).charAt(0).toUpperCase() + (rsvp.status as string).slice(1)}
                                            </Badge>
                                        </TableCell>
                                        <TableCell>
